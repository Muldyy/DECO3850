...
public class LandManControl : MonoBehaviour
{
    ...
    //A numerical constant for conversion form sandpit resolutio to screen displacement
    ...
    void Update()
    {
        ...
        int[] heatMap = pathFinder.getHeatMap1();
        ...
        {
            spawnControl.Spawn(2);
            Destroy(this.gameObject);
        }
        else if (heatMap[startY * 424 + startX] == 9950)
        {
            spawnControl.Spawn(2);
        }
